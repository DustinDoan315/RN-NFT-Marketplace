export const icons = {
  ...
  paid_orange: require('./AppIcons/paid_orange.png'),
  paid_blue: require('./AppIcons/paid_blue.png'),
  paid_green: require('./AppIcons/paid_green.png'),
  paid_pink: require('./AppIcons/paid_pink.png'),
  filter: require('./AppIcons/filter.png'),
  more_black: require('./AppIcons/more_black.png'),
  bell_on: require('./AppIcons/bell_on.png'),
  add_card: require('./AppIcons/add_card.png'),
  arrow_down: require('./AppIcons/arrow_down.png'),
  arrow_up: require('./AppIcons/arrow_up.png'),
